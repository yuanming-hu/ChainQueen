...
void MPMGradKernelLauncher(int dim,
                           ...
                           float *grad_inA,
                           float *grad_ingrid,
                           const float *grad_outx,
                           const float *grad_outv,
                           const float *grad_outF,
                           const float *grad_outC,
                           const float *grad_outP,
                           const float *grad_outgrid,
 ...
 public:
  ...
  void Compute(OpKernelContext *context) override {
    ...
    OP_REQUIRES_OK(context,
                   context->allocate_output(5, grid_shape, &grad_ingrid));
